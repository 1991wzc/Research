...
def ja_processor():
    ...
    stopwords = ['注釈','ー','年', '日', '月', 'こと', '的', 'ため', '出典', 'フリー', '百科', '事典', 'ウィキペディア', '百科事典', '検索', '記事', 'ノート', 'ページ', '目次', 'その他', 'できる', '情報源',
                 'まり', '編集', 'ジャンル', '複数', '文献', '情報', '概要', '基本', '要出典', '種類', '項目','カテゴリ', '名前', '期間', '外部', '内容','ウィキ', 'ペ', 'ディア',
                 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'wikipedia', 'encyclopedia', 'navigation',
                 'search','info', 'site', 'watch', 'link', 'log', 'talk', 'history', 'ch', 'isbn', 'centralnotice', 'th', 'bb', 'ii', 'co', 'ltd', 'the','vf','ver','vol',
